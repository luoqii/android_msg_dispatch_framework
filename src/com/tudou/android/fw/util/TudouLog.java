 ...
 * <p>
 * Firstly, you must toggle log on by {@link #setLog(boolean)}. Secondly, you
 * can toggle log-to-file by {@link #setLog2File(boolean)} and initiate with by
 * {@link #init(String, String, boolean))}.
 * 
 * @author bysong@tudou.com
 */
public class TudouLog {
    private static final String TAG = TudouLog.class.getSimpleName();
    ...
    private static final int LIMIT = 1 * 1024 * 1024; // 1M

    private static Formatter sFormater;
    
    private TudouLog(){};// Utility class, do not instantiate.
