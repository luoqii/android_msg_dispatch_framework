...
@MsgHandler
public class AnnotationFrameLayout extends android.widget.FrameLayout {
    private static final String TAG = LinearLayout.class.getSimpleName();

    public AnnotationFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AnnotationFrameLayout(Context context) {
        super(context);
    }
