...
@RootMsgHandler
public class RootLinearLayout extends android.widget.LinearLayout
        implements com.tudou.android.fw.msgdispatch.RootMsgHandler{

    protected static final String TAG = RootLinearLayout.class.getSimpleName();
    ...
    public void onUnhandledMsg(IMsg msg) {
        if (null != mListener) {
            ...
            Log.w(TAG, "no onUnhandledMsg yet. root: " + this);
        }
    }
