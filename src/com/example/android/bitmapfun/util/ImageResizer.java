...
public class ImageResizer extends ImageWorker {
    ...
    protected Bitmap processBitmap(Object imgUrl, Object imagview) {
        return processBitmap(Integer.parseInt(String.valueOf(imgUrl)));
    }
    ...
    /**
     * Decode and sample down a bitmap from InputStream to the requested width
     * and height.
     * 
     ...
     * @throws IOException
     */
    public static synchronized Bitmap decodeSampledBitmapFromByteArray(byte[] data, int reqWidth,
            int reqHeight) throws IOException {
        // First decode with inJustDecodeBounds=true to check dimensions
        reqWidth = reqWidth >= 480 ? 480 : reqWidth;
        reqHeight = reqHeight >= 240 ? 240 :reqHeight;
        final BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
