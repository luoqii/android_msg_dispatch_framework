...
public class ImageCache {
    ...
    private void init(Context context, ImageCacheParams cacheParams) {
        final File diskCacheDir = DiskLruCache.getDiskCacheDir(context, cacheParams.type.name());
    ...
    public static class ImageCacheParams {
        ...
        public ImageCacheParams(ImageType type) {
            this.type = type;
            if (type.equals(ImageType.SOURCE_SITE)) {
