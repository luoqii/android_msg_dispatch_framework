...
public abstract class ImageWorker {
     ...
     * {@link ImageWorker#processBitmap(Object, Object)} to define the
     * processing logic). A memory and disk cache will be used if an
     * {@link ImageCache} has been set using
     * {@link ImageWorker#setImageCache(ImageCache)}. If the image is found in
     * the memory cache, it is set immediately, otherwise an {@link AsyncTask}
    ...
    public void loadImage(Object data, ImageView imageView) {
        loadImage(data, imageView, mLoadingBitmap, ImageView.ScaleType.CENTER);
    }
     ...
     * @param imageView The ImageView to bind the downloaded image to.
     * @param Bitmap TODO
     * @param loadingScaleType TODO
     */
    public void loadImage(Object data, ImageView imageView,
            Bitmap loadingBitmap, ScaleType loadingScaleType) {
        ...
        if (bitmap != null) {
            ...
            Bitmap loading = loadingBitmap;
            if (loading == null) {
                loading = mLoadingBitmap;
            }
            final AsyncDrawable asyncDrawable = new AsyncDrawable(
                    mContext.getResources(), loading, task);
     ...
     */
    public void loadImage(Object data, ImageView imageView,
            boolean hasDefaultLoadingImg) {
        if (hasDefaultLoadingImg) {
     ...
     * 
     * @param imgUrl The data to identify which image to process, as provided by
     *            {@link ImageWorker#loadImage(Object, ImageView, int, ScaleType)}
     * @param imagview TODO
     * @return The processed bitmap
     */
    protected abstract Bitmap processBitmap(Object imgUrl, Object imagview);
